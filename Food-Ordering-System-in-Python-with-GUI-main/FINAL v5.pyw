...
def bill():
    ...
    receipt.insert(END,"\t\t\t\t         Sadar, Nagpur\n")
    receipt.insert(END,"\t\t\t\t         NGP, 440001\n")
    receipt.insert(END,"\t\t\t            TEL: +91 846-435-0135\n\n")
    ...
    if(bc1==1):
        ...
        to=str(db.peek1())
        receipt.insert(END,"\n==================================================================================\n")
        receipt.insert(END," Bill no.:"+adbill+"                                                                                                             TOTAL:    Rs"+to+"\n")
        receipt.insert(END,"==================================================================================\n")
    elif(bc2==1):
        adbill=adb.peekbil()
        adbill=adbill + 1
